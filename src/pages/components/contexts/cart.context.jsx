...
const removeCartItem = (cartItems, cartItemToRemove) => {
  ...
  const clearCartItem = (cartItems, cartItemToFormat) => {
    return cartItems.filter((cartItem) => cartItem.product_id !== cartItemToFormat.product_id);
  }
...
export const CartProvider = ({children}) =>  {
    ...
    const clearItemFromCart = (cartItemToFormat) => {
        setCartItems(clearCartItem(cartItems, cartItemToFormat))
    };
