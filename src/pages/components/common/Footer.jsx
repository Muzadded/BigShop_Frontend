        ...
        <div className="row px-xl-5 pt-5">
          <div className="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
            <a href className="text-decoration-none">
              <h1 className="mb-4 display-5 font-weight-semi-bold"><span className="text-primary font-weight-bold border border-white px-3 mr-1">BB</span>BoroBazar</h1>
            </a>
            <p>Dolore erat dolor sit lorem vero amet. Sed sit lorem magna, ipsum no sit erat lorem et magna ipsum dolore amet erat.</p>
            <p className="mb-2"><i className="fa fa-map-marker-alt text-primary mr-3" />Dhaka-1219,Bangladesh</p>
            <p className="mb-2"><i className="fa fa-envelope text-primary mr-3" />bb@example.com</p>
            ...
            <div className="row">
              <div className="col-md-4 mb-5">
                ...
                <div className="d-flex flex-column justify-content-start">
                  ...
                  <a className="text-dark" href="#"><i className="fa fa-angle-right mr-2" />Contact Us</a>
                </div>
              </div>
              <div className="col-md-5 mb-6 ml-5">
        ...
        <div className="row border-top border-light mx-xl-5 py-4">
          <div className="col-md-6 px-xl-0">
            <p className="mb-md-0 text-center text-md-left text-dark">
              © <a className="text-dark font-weight-semi-bold" href="#">BoroBazar</a>. All Rights Reserved. Designed
              by
              <a className="text-dark font-weight-semi-bold" href="https://htmlcodex.com">Muzadded</a><br />
              Distributed By <a href="https://themewagon.com" target="_blank">CDIP</a>
            </p>
          </div>
